...
function kelweaver_scripts() {
	wp_enqueue_style(
		...
		'https://fonts.googleapis.com/css2?family=Merriweather:ital,wght@0,400;0,700;1,400&family=Fraunces:opsz,wght@9..144,600;9..144,700&family=Source+Sans+3:wght@400;700&family=Dancing+Script:wght@400;700&family=Pacifico&family=Kaushan+Script&family=Yellowtail&family=Satisfy&family=Alex+Brush&family=Great+Vibes&family=Sacramento&display=swap',
		array(),
		null
	);
	wp_enqueue_style(
